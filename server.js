...
const port = process.env.PORT || 3000 //Read PORT env variable, if not there, use default of 3000
...
app.get( '/', ( req, res ) => {
  ...
  // } )
  res.render( 'home.hbs', {
    pageTitle: 'Home Page for Chin\'s website',
...
app.get( '/bad', ( req, res ) => {
  res.send( {
    errorMessage: 'Error getting request!',
  } );
} );
